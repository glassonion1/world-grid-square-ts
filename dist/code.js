...
exports.codeToBbox = exports.codeToPoint = exports.codeToLevel = exports.parseFirstDigit = void 0;
const model_1 = require("./model");
const divideGrid = (parent, level, divide) => {
    ...
    const [signX, signY] = (0, exports.parseFirstDigit)(code);
...
const toLv1 = (code) => {
    const [signX, signY, z] = (0, exports.parseFirstDigit)(code);
...
exports.codeToLevel = codeToLevel;
/**
 ...
 */
const codeToPoint = (code, anchorX = 0.0, anchorY = 0.0) => {
    ...
    const level = (0, exports.codeToLevel)(code);
...
exports.codeToPoint = codeToPoint;
/**
 ...
 * @returns Bbox object
 */
const codeToBbox = (code) => {
    const ws = (0, exports.codeToPoint)(code, 0, 0);
    const en = (0, exports.codeToPoint)(code, 1, 1);
    return {
        west: ws.lng,
        south: ws.lat,
        east: en.lng,
